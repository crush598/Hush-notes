...
​	<mark> $grad &=& \frac{\mathrm{d}loss}{\mathrm{d}W} = \frac{\mathrm{d}loss}{\mathrm{d}prob} * \frac{\mathrm{d}prob}{\mathrm{d}z} * \frac{\mathrm{d}z}{\mathrm{d}W} \\ &=&X^T(-\frac{y}{prob} + \frac{1 - y}{1-prob})*prob(1 - prob) \\ &=& X^T(-y(1-prob) + (1-y)prob) \\ &=&X^T(prob - y)$ </mark>
